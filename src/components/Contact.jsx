...
const Contact = () => {
  ...
  return (
    <section
      ref={ref}
      id="contact"
      className="bg-white w-full min-h-screen relative overflow-hidden flex items-end pt-32 pb-0 md:pb-0 border-t border-gray-200"
    >
      ...
      >
        <h1
          className="text-[25vw] leading-[0.75] font-black text-black uppercase tracking-tighter select-none scale-y-[1.6] origin-top"
      ...
      <div className="relative z-10 w-full flex justify-end items-end">
        ...
        <div
          data-aos="fade-up"
          className="bg-black w-full md:w-[85%] lg:w-[75%] p-8 md:p-16 text-white flex flex-col justify-between"
        >
              ...
              <div className="flex-1 flex flex-col gap-10">
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    className="w-full bg-transparent border-b border-white/40 pb-3 text-lg text-white focus:outline-none focus:border-white transition-colors placeholder-white font-medium rounded-none"
                  />
                </div>
              ...
              <div className="flex-1 flex flex-col">
                ...
                <div className="relative h-full flex flex-col">
                  ...
                  <textarea
                    ...
                    required
                    className="w-full h-full min-h-[120px] bg-transparent border-b border-white/40 pb-3 text-lg text-white focus:outline-none focus:border-white transition-colors placeholder-white font-medium resize-none rounded-none"
                  ></textarea>
