...
import heroVideo from '../assets/hero video/riyas-hero.mp4';
    ...
    <section className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="hidden lg:flex flex-col gap-6 fixed left-6 top-1/2 -translate-y-1/2 z-50 mix-blend-difference">
        ...
        <a
          ...
          className="text-white/80 hover:text-[#00D4FF] transition-all duration-300 transform hover:scale-125"
          aria-label="GitHub"
        >
          <svg
            className="w-5 h-5"
      ...
      <div className="absolute inset-0 z-20 px-6 pb-20 md:pb-[8%] md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full">
          ...
          >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-white/80 hover:text-[#00D4FF] transition-colors duration-300"
              aria-label="GitHub"
            >
              <svg
                className="w-5 h-5"
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688 0 0-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z"
                  clipRule="evenodd"
                />
              </svg>
            </a>
          ...
          >
            <span className="block text-white font-black tracking-[0.08em] uppercase">
              DATA ANALYTICS
          ...
          >
            ...
            <a
              ...
              download="Riyas_Khan_Resume.pdf"
        ...
        >
          ...
          {/* Play Circle */}
          <div className="w-12 h-12 md:w-20 md:h-20 rounded-full border border-black/30 bg-transparent backdrop-blur-md flex justify-center items-center group-hover:scale-110 group-hover:bg-white transition-all duration-500 shadow-[0_0_30px_rgba(0,0,0,0.1)]">

            {!isPlaying || isMuted ? (
              <svg
                className="w-5 h-5 md:w-8 md:h-8 text-black group-hover:text-black ml-0.5 md:ml-1 transition-colors duration-300"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
              ...
              <svg
                className="w-5 h-5 md:w-8 md:h-8 text-black group-hover:text-black transition-colors duration-300"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
          ...
          {/* Play Reel */}
          <span className="text-white text-[10px] md:text-xs font-bold tracking-widest uppercase opacity-100 transition-all duration-300">
